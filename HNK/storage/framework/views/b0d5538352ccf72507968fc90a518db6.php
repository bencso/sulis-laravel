        ...
        <div class="col-md">
            <div class="card bg-light mb-3">
                ...
                <div class="card-body fs-3">
                    <p class="card-text text-center"><?php echo e($varosSzam); ?> darab</p>
                </div>
            </div>
        </div>
        <div class="col-md">
            <div class="card bg-light mb-3">
                ...
                <div class="card-body fs-3">
                    <p class="card-text text-center"><?php echo e($nagyKozsegSzam); ?> darab</p>
                </div>
            </div>
        </div>
        <div class="col-md">
            <div class="card bg-light mb-3">
                ...
                <div class="card-body fs-3">
                    <p class="card-text text-center"><?php echo e($kozsegSzam); ?> darab</p>
                </div>
            </div>
        </div>
        <div><iframe
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\babolnai.bence\Desktop\HNK\website\resources\views/welcome.blade.php ENDPATH**/ ?>