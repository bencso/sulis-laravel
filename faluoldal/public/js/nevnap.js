...
document.getElementById("nevnap").innerHTML = `${Ev}. ${Honev(Ho)} ${Nap}., ${Week(NapSorsz)} <br/>
<span style="color: rgb(0, 83, 151); font-weight:bold;">${Havinev(Ev,Ho,Nap)}</span> névnapja van.`;
